        ...
        children: [
          ...
          ...List.generate(3, (index) {
            ...
            String levelText = level == 1
                ? 'المرحلة الأولى'
                : (level == 2 ? 'المرحلة الثانية' : 'المرحلة الثالثة');
            String difficulty =
                level == 1 ? 'سهلة' : (level == 2 ? 'متوسطة' : 'صعبة');
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              _buildScoreCard(
                  'النقاط', score.toString(), const Color(0xFF4CAF50)),
              _buildScoreCard(
                  'المحاولات', moves.toString(), const Color(0xFFFF9800)),
              if (showAllCards)
                _buildScoreCard(
                    'حفظ الأوراق', '3 ثواني', const Color(0xFF6C63FF)),
            ],
          ),
        ),
