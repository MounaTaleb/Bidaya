...
class _LoginFormPageState extends State<LoginFormPage2>
  ...
  void _confirmLogin() async {
    ...
    final displayName = emailName.substring(0, 1).toUpperCase() +
        (emailName.length > 1 ? emailName.substring(1) : '');

    // Données par défaut pour l'utilisateur
    const defaultAge = 8;
    const defaultAvatar = 'assets/images/avatar1.png';

    // Sauvegarder les données
    await _saveUserData(email, displayName, defaultAge, defaultAvatar);
  ...
  void _signInWithGoogle() async {
    // Email par défaut pour Google
    const googleEmail = 'user@gmail.com';
    const googleName = 'مستخدم Google';
    const defaultAge = 8;
    const defaultAvatar = 'assets/images/avatar2.png';

    // Sauvegarder les données
    await _saveUserData(googleEmail, googleName, defaultAge, defaultAvatar);
